<?php
$pageTitle = "Tambah Catatan Makanan";
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-500 md:ml-2">Tambah Catatan</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah Catatan Makanan</h1>
            <p class="text-gray-600">Catat makanan yang Anda konsumsi untuk memantau asupan kalori harian.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2">
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <form id="foodJournalForm" class="space-y-6">
                        <!-- Pencarian Makanan -->
                        <div class="relative">
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="Tambahkan catatan tentang makanan ini..."></textarea>
                        </div>
...
document.getElementById('foodJournalForm').addEventListener('submit', async function(e) {
    e.preventDefault();

    const formData = new FormData(this);
    
    try {
        const response = await fetch('/albi/food-journal', {
            method: 'POST',
            body: formData
        });
        ...
        if (response.ok) {
            ...
            alert(result.error || 'Terjadi kesalahan saat menyimpan catatan');
        }
    } catch (error) {
